...
class Shot(pg.sprite.Sprite):
    ...
    def __init__(self, pos):
        pg.sprite.Sprite.__init__(self, self.containers)
        self.image = pg.Surface([9, 18], pg.SRCALPHA, 32)
...
class Bomb(pg.sprite.Sprite):
    ...
    def __init__(self, alien):
        pg.sprite.Sprite.__init__(self, self.containers)
        self.image = pg.Surface([16, 24], pg.SRCALPHA, 32)
...
def main(winstyle=0):
    ...
    Explosion.image = pg.Surface([90, 90], pg.SRCALPHA, 32)
    Explosion.image.fill((0, 0, 0, 0))
    pg.draw.circle(Explosion.image, (255, 255, 0, 100), (45, 45), 45)
    pg.draw.circle(Explosion.image, (255, 120, 0, 100), (45, 45), 25)
