...
class SpaceObjectRenderer:
    ...
    def update(self):
        ...
        for so in self.space_objects:
            ...
            so.velocity[0] = so.velocity[0] + a[i][0] * self.grav_field.delta_t
            so.velocity[1] = so.velocity[1] + a[i][1] * self.grav_field.delta_t
        pass


def distance(a: SpaceObject, b: SpaceObject):
...
def direction(a: SpaceObject, b: SpaceObject):
